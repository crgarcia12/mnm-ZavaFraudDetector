...
public class SsoSessionService {
    public static final String SESSION_USER = "zavaFraudDetector.user";
    ...
    public SessionUser resolveSessionUser(HttpServletRequest request, String explicitToken) {
        ...
        try (Connection connection = FraudConnectionFactory.openConnection();
    ...
    private String extractToken(HttpServletRequest request) {
        ...
        String cookieName = FraudConfig.getSsoCookieName();
    ...
    private String resolveTokenFromAuthGateway(String cookieName, String cookieValue) {
        String whoAmIUrl = normalize(FraudConfig.getAuthGatewayWhoAmIUrl());
